                        ...
                        <div class="col-md-12">                            
                                        ...
                                        <tbody>
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-quantity">
                                                    <div class="quantity"> <input type="button" value="-" class="minus"> <input class="input-text qty text" step="1" title="Qty" type="number" value="1"> <input type="button" value="+" class="plus"> </div>
                                                </td>
                                            ...
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-quantity">
                                                    <div class="quantity"> <input type="button" value="-" class="minus"> <input class="input-text qty text" max="16" step="1" title="Qty" type="number" value="1"> <input type="button" value="+" class="plus"> </div>
                                                </td>
                                            ...
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-quantity">
                                                    <div class="quantity"> <input type="button" value="-" class="minus"> <input class="input-text qty text" name="" size="4" step="1" title="Qty" type="number" value="1"> <input type="button" value="+" class="plus"> </div>
                                                </td>
                                ...
                                <div class="row">
                                    <div class="col-md-6 element-bottom-20">
                                        <div class="input-group"> <input class="input-text form-control" id="coupon_code" name="coupon_code" placeholder="Coupon code"> <span class="input-group-btn">
                                        <input class="btn btn-primary" name="apply_coupon" type="submit" value="Apply Coupon">
                                    </span> </div>
                                    </div>
                                    <div class="col-md-3 element-bottom-20"> <button class="btn btn-info btn-block" name="update_cart" type="submit" value="true">
                                    <i class="fa fa-refresh"></i>
                                    Update Cart
                                </button> </div>
                                    <div class="col-md-3 element-bottom-20"> 
                                        <a href="<?=base_url();?>index.php/checkout_controller/proceed_checkout">
                                            <button class="btn btn-success btn-block" name="proceed"  value="true">
                                            Proceed to Checkout
                                ...
                                <table cellspacing="0" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="shipping">
                                            ...
                                            <td>Free Shipping <input class="shipping_method" data-index="0" type="hidden" value="free_shipping"></td>
                                        </tr>
