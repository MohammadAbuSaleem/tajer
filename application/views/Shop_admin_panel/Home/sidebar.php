        ...
        <nav id="sidebar" class="sidebar-wrapper">
            <div class="sidebar-content">
                ...
                <div class="sidebar-header">
                    <div class="user-pic" style = 'max-height: 60px'>
                    ...
                    <ul>
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="<?=base_url('/index.php/shop_admin_panel_main')?>">Dashboard</a>
                                    </li>
                                    <li>
                                        <a href="<?=base_url('/index.php/shop_admin_panel_main/go_messages')?>">Messages</a>
                                    </li>
                                    <li>
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                     <li>
                                        <a href="<?=base_url('/index.php/shop_admin_panel_main/go_categories')?>">Categories</a>
                                    </li>
                                    <li>
                                        <a href="<?=base_url('/index.php/shop_admin_panel_main/go_sub_categories')?>">Sub Categories</a>
                                    </li>
                                    <li>
                                        <a href="<?=base_url('/index.php/shop_admin_panel_products/go_products')?>">products</a>
                                    </li>
                                    <li>
                                        <a href="#">Orders</a>
                                    </li>
