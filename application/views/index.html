        ...
        <div class="logo-navbar container-logo">
            <div class="container">
                <div class="navbar-header"> <button class="navbar-toggle collapsed" data-target=".main-navbar" data-toggle="collapse" type="button">
                    ...
                    <a class="navbar-brand" href="shop-index.html"> <img alt="Lambda Theme - Shop" src="assets/images/shop/lambda-shop.png"> </a>
                ...
                <nav class="collapse navbar-collapse main-navbar">
                    <div class="menu-container">
                        <ul class="nav navbar-nav" id="menu-main">
                            ...
                            <li class="menu-item dropdown  menu-item-object-oxy_mega_menu"> <a href="/shop-womens-category.html">Womens</a>
                            ...
                            <li class="menu-item dropdown  menu-item-object-oxy_mega_menu"> <a href="/shop-mens-category.html">Mens</a>
                            ...
                            <li class="menu-item dropdown  menu-item-object-oxy_mega_menu"> <a href="/shop-kids-category.html">Kids</a>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="figure element-top-30 element-bottom-20 image-effect-scroll-right os-animation" data-os-animation="fadeIn" data-os-animation-delay="0s">
                                <a class="figure-image" href="shop-mens-category.html" target="_self"> <img alt="woman-sales" src="assets/images/shop/woman-sales-notinclude.jpg"> </a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="figure element-top-30 element-bottom-0 image-effect-scroll-left os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.2s">
                                <a class="figure-image" href="shop-mens-category.html" target="_self"> <img alt="kids-sales" src="assets/images/shop/kids-sales-notinclude.jpg"> </a>
                            </div>
                            <div class="figure element-top-30 element-bottom-20 image-effect-scroll-left os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.4s">
                                <a class="figure-image" href="shop-mens-category.html" target="_self"> <img alt="mans-sales" src="assets/images/shop/mans-sales-notinclude.jpg"> </a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <ul class="products">
                                        ...
                                        <div class="product-image">
                                            ...
                                            <div class="product-image-back"><img alt="skirt4-1" src="assets/images/shop/skirt4-2-700x893.jpg"></div>
                                        ...
                                        <li class="product col-md-3">
                                            <a href="shop-simple-product.html"> <span class="onsale">Sale!</span>
                                                <div class="product-image">
                                                    <div class="product-image-front"> <img alt="bag1-1" height="893" src="assets/images/shop/bag1-1-700x893.jpg" width="700"> </div>
                                                    <div class="product-image-back"> <img alt="bag1-2" src="assets/images/shop/bag1-2-700x893.jpg"> </div>
                                                    <div class="product-image-overlay">
                                                        <h4>View Details</h4>
                                                    </div>
                                                </div>
                                        ...
                                        <li class="product col-md-3">
                                            <a href="shop-simple-product.html"> <span class="onsale">Sale!</span>
                                                <div class="product-image">
                                                    <div class="product-image-front"> <img alt="bag3-1" height="893" src="assets/images/shop/bag3-1-700x893.jpg" width="700"> </div>
                                                    <div class="product-image-back"> <img alt="bag3-2" src="assets/images/shop/bag3-2-700x893.jpg"> </div>
                                                    <div class="product-image-overlay">
                                                        <h4>View Details</h4>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="product-image">
                                        <div class="product-image-front">
                                            <img alt="bag5-1" height="893" src="assets/images/shop/bag5-1-700x893.jpg" width="700">
                                        </div>

                                        <div class="product-image-back">
                                            <img alt="bag3-1" src="assets/images/shop/bag3-1-700x893.jpg">
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="figure element-top-30 element-bottom-30 os-animation" data-os-animation="fadeIn" data-os-animation-delay="0s">
                                <a class="figure-image" href="shop-mens-category.html" target="_self"> <img alt="womans-full" src="assets/images/shop/womans-full-notinclude.jpg"> </a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="woocommerce columns-5">
                                <div class="row">
                                    <ul class="products">
                                        ...
                                        <div class="product-image">
                                            <div class="product-image-front">
                                                <img alt="skirt1-1" height="893" src="assets/images/shop/skirt1-1-700x893.jpg" width="700">
                                            </div>

                                            <div class="product-image-back"><img alt="skirt1-2" src="assets/images/shop/skirt1-2-700x893.jpg"></div>
                                        ...
                                        <li class="product col-md-2-4">
                                            <a href="shop-simple-product.html"> <span class="onsale">Sale!</span>
                                                <div class="product-image">
                                                    <div class="product-image-front"> <img alt="bag4-1" height="893" src="assets/images/shop/bag4-1-700x893.jpg" width="700"> </div>
                                                    <div class="product-image-back"> <img alt="bag4-2" src="assets/images/shop/bag4-2-700x893.jpg"> </div>
                                                    <div class="product-image-overlay">
                                                        <h4>View Details</h4>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="product-image">
                                        <div class="product-image-front">
                                            <img alt="dress2-1" height="893" src="assets/images/shop/dress2-1-700x893.jpg" width="700">
                                        </div>

                                        <div class="product-image-back">
                                            <img alt="dress1-1" src="assets/images/shop/dress2-2-700x893.jpg">
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 text-center">
                            <div class="figure element-top-20 element-bottom-20 image-effect-zoom-in os-animation" data-os-animation="fadeIn" data-os-animation-delay="0s">
                                <a class="figure-image" href="shop-mens-category.html" target="_self"> <img alt="" src="assets/images/shop/banner-small-1-notinclude.jpg"> </a>
                            </div>
                        </div>
                        <div class="col-md-4 text-center">
                            <div class="figure element-top-20 element-bottom-20 image-effect-zoom-in os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.2s">
                                <a class="figure-image" href="shop-mens-category.html" target="_self"> <img alt="banner-small-2" src="assets/images/shop/banner-small-2-notinclude.jpg"> </a>
                            </div>
                        </div>
                        <div class="col-md-4 text-center">
                            <div class="figure element-top-20 element-bottom-20 image-effect-zoom-in os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.4s">
                                <a class="figure-image" href="shop-mens-category.html" target="_self"> <img alt="banner-small-3" src="assets/images/shop/banner-small-3-notinclude.jpg"> </a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="woocommerce columns-6">
                                <div class="row">
                                    <ul class="products">
                                        ...
                                        <li class="product col-md-2">
                                            <a href="shop-simple-product.html">
                                                <div class="product-image">
                                                    <div class="product-image-front"> <img alt="jeans1-1" height="893" src="assets/images/shop/jeans1-1-700x893.jpg" width="700"> </div>
                                                    <div class="product-image-back"> <img alt="jeans1-2" src="assets/images/shop/jeans1-2-700x893.jpg"> </div>
                                                    <div class="product-image-overlay">
                                                        <h4>View Details</h4>
                                                    </div>
                                                </div>
                                        ...
                                        <li class="product col-md-2">
                                            <a href="shop-simple-product.html"> <span class="onsale">Sale!</span>
                                                <div class="product-image">
                                                    <div class="product-image-front"> <img alt="top1-1" height="893" src="assets/images/shop/top1-1-700x893.jpg" width="700"> </div>
                                                    <div class="product-image-back"> <img alt="top1-2" src="assets/images/shop/top1-2-700x893.jpg"> </div>
                                                    <div class="product-image-overlay">
                                                        <h4>View Details</h4>
                                                    </div>
                                                </div>
                                        ...
                                        <li class="product col-md-2">
                                            <a href="shop-simple-product.html">
                                                <div class="product-image">
                                                    <div class="product-image-front"> <img alt="top2-1" height="893" src="assets/images/shop/top2-1-700x893.jpg" width="700"> </div>
                                                    <div class="product-image-back"> <img alt="top2-2" src="assets/images/shop/top2-2-700x893.jpg"> </div>
                                                    <div class="product-image-overlay">
                                                        <h4>View Details</h4>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="product-image">
                                        <div class="product-image-front">
                                            <img alt="dress1-1" height="893" src="assets/images/shop/dress1-1-700x893.jpg" width="700">
                                        </div>

                                        <div class="product-image-back">
                                            <img alt="dress1-1" src="assets/images/shop/dress1-2-700x893.jpg">
                                        </div>
                            ...
                            <div class="woocommerce columns-6">
                                <div class="row">
                                    <ul class="products">
                                        ...
                                        <div class="product-image">
                                            <div class="product-image-front">
                                                <img alt="jacket2-1" height="893" src="assets/images/shop/jacket2-1-700x893.jpg" width="700">
                                            </div>

                                            <div class="product-image-back"><img alt="jacket2-2" src="assets/images/shop/jacket2-2-700x893.jpg"></div>
                                        ...
                                        <li class="product col-md-2">
                                            <a href="shop-simple-product.html">
                                                <div class="product-image">
                                                    <div class="product-image-front"> <img alt="jacket1-1" height="893" src="assets/images/shop/jacket1-1-700x893.jpg" width="700"> </div>
                                                    <div class="product-image-back"><img alt="jacket1-1" src="assets/images/shop/jacket1-2-700x893.jpg"></div>
                                                    <div class="product-image-overlay">
                                                        <h4>View Details</h4>
                                                    </div>
                                                </div>
                                        ...
                                        <li class="product col-md-2">
                                            <a href="shop-simple-product.html">
                                                <div class="product-image">
                                                    <div class="product-image-front"> <img alt="hoodie1-1" height="893" src="assets/images/shop/hoodie1-1-700x893.jpg" width="700"> </div>
                                                    <div class="product-image-back"> <img alt="hoodie1-2" src="assets/images/shop/hoodie1-2-700x893.jpg"> </div>
                                                    <div class="product-image-overlay">
                                                        <h4>View Details</h4>
                                        ...
                                        <li class="product col-md-2">
                                            <a href="shop-simple-product.html"> <span class="onsale">Sale!</span>
                                                <div class="product-image">
                                                    <div class="product-image-front"> <img alt="shirt1-1" height="893" src="assets/images/shop/shirt1-1-700x893.jpg" width="700"> </div>
                                                    <div class="product-image-back"> <img alt="shirt1-2" src="assets/images/shop/shirt1-2-700x893.jpg"> </div>
                                                    <div class="product-image-overlay">
                                                        <h4>View Details</h4>
                                                        <div class="star-rating" title="Rated 4.00 out of 5"> <span style="width:80%"><strong class="rating">4.00</strong> out of 5</span> </div>
                                                    </div>
                                        ...
                                        <li class="product col-md-2">
                                            <a href="shop-simple-product.html">
                                                <div class="product-image">
                                                    <div class="product-image-front"> <img alt="shirt2-1" height="893" src="assets/images/shop/shirt2-1-700x893.jpg" width="700"> </div>
                                                    <div class="product-image-back"> <img alt="shirt2-2" src="assets/images/shop/shirt2-2-700x893.jpg"> </div>
                                                    <div class="product-image-overlay">
                                                        <h4>View Details</h4>
                                    ...
                                    <div class="product-image">
                                        <div class="product-image-front">
                                            <img alt="hoodie2-1" height="893" src="assets/images/shop/hoodie2-1-700x893.jpg" width="700">
                                        </div>

                                        <div class="product-image-back">
                                            <img alt="hoodie2-1" src="assets/images/shop/hoodie2-2-700x893.jpg">
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flexslider flex-controls-bottom element-top-0 element-bottom-20 os-animation" data-flex-animation="slide" data-flex-captionhorizontal="left" data-flex-controls="hide" data-flex-controlsalign="center" data-flex-controlsposition="inside"
                                ...
                                <ul class="slides">
                                    <li>
                                        <figure> <img alt="chanel-notinclude" class="attachment-full wp-post-image" height="200" src="assets/images/shop/chanel-notinclude.png" width="200"> </figure>
                                    </li>
                                    <li>
                                        <figure> <img alt="diesel-notinclude" class="attachment-full wp-post-image" height="200" src="assets/images/shop/diesel-notinclude.png" width="200"> </figure>
                                    </li>
                                    <li>
                                        <figure> <img alt="hm-notinclude" class="attachment-full wp-post-image" height="200" src="assets/images/shop/hm-notinclude.png" width="200"> </figure>
                                    </li>
                                    <li>
                                        <figure> <img alt="knsley-notinclude" class="attachment-full wp-post-image" height="200" src="assets/images/shop/knsley-notinclude.png" width="200"> </figure>
                                    </li>
                                    <li>
                                        <figure> <img alt="lecoq-notinclude" class="attachment-full wp-post-image" height="200" src="assets/images/shop/lecoq-notinclude.png" width="200"> </figure>
                                    </li>
                                    <li>
                                        <figure> <img alt="levis-notinclude" class="attachment-full wp-post-image" height="200" src="assets/images/shop/levis-notinclude.png" width="200"> </figure>
                                    </li>
                                    <li>
                                        <figure> <img alt="nike-notinclude" class="attachment-full wp-post-image" height="200" src="assets/images/shop/nike-notinclude.png" width="200"> </figure>
                                    </li>
                                    <li>
                                        <figure> <img alt="pullbear-notinclude" class="attachment-full wp-post-image" height="200" src="assets/images/shop/pullbear-notinclude.png" width="200"> </figure>
                                    </li>
                                    <li>
                                        <figure> <img alt="zara-notinclude" class="attachment-full wp-post-image" height="200" src="assets/images/shop/zara-notinclude.png" width="200"> </figure>
                                    </li>
                                </ul>
                        </div>
                    </div>
